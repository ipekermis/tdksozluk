...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                      ...
                      child: Padding(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            final word =
                                homeController.searchHistory[index].word;
                            final String? subtitle =
                                homeController.searchHistory[index].type;
                            return Column(
                              children: [
                                ListTile(
                                  leading: Icon(
                                  ...
                                  trailing: IconButton(
                                    icon: Icon(
                                      homeController.isFavorite(word)
                                          ? Icons.star
                                          : Icons.star_border,
                                      color:
                                          homeController.isFavorite(word)
                                          ...
                                          children: [
                                            if (anlam.ozelliklerListe != null &&
                                              ...
                                              Padding(
                                                ...
                                                child: Text(
                                                  "${anlam.anlamSira}. ${anlam.ozelliklerListe![0].tamAdi}",
                                                  style: TextStyle(
                                                    fontSize: 14,
                                                    fontStyle: FontStyle.italic,
                                                    color: Color(0xFFCC2041),
      ...
      bottomNavigationBar: BottomNavBar(ind: 0),
    );
  }
}
